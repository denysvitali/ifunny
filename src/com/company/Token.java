...
public class Token {
    ...
    public enum Type{
        ...
        PRINT, PRINTLN, ID, NUM, STRING, SEMICOLON, COMMA, ARROW, OPNRNBRACKETS,
        CLSRNBRACKETS, OPNCRLYBRACKETS, CLSCRLYBRACKETS, ESCLMARK, MULT, DIV, MOD,
        SUM, SUB, MIN, MINEQ, MAJ, MAJEQ, EQ, NEQ, AND, OR, ASSIGNM, ASSIGNMSUM,
